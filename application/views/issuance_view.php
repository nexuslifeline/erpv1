...
$(document).ready(function(){
    var dt; var _txnMode; var _selectedID; var _selectRowObj; var _cboDepartments;
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_issuances').DataTable({
            ...
            "columns": [
                ...
                { targets:[3],data: "issued_to_person" },
    ...
    var newRowItem=function(d){
        ...
        '<td width="11%"><input name="issue_discount[]" type="text" class="numeric form-control" value="'+ accounting.formatNumber(d.issue_discount,2)+'" style="text-align:right;"></td>'+
        ...
        '<td width="11%"><input name="issue_tax_rate[]" type="text" class="numeric form-control" value="'+ accounting.formatNumber(d.issue_tax_rate,2)+'"></td>'+
