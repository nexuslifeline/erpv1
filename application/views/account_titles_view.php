                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="panel-body table-responsive">
                                            <table id="tbl_accounts" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                <thead>
                                                <tr>
                                                    <th></th>
                                                    <th>Account #</th>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="frm_accounts" role="form" class="form-horizontal row-border">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Parent Account :</label>
...
<div id="modal_new_account_class" class="modal fade" tabindex="-1" role="dialog"><!--modal-->
    <div class="modal-dialog modal-md">
        <div class="modal-content"><!---content--->
            <div class="modal-header">
                <button type="button" class="close"   data-dismiss="modal" aria-hidden="true">X</button>
                <h4 class="modal-title"><span id="modal_mode"> </span>New Classification</h4>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        ...
        var createToolBarButton=function(){
            var _btnNew='<button class="btn btn-primary"  id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="Create New Account" >'+
                '<i class="fa fa-users"></i> Create New Account</button>';
